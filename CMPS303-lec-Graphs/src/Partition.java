...
public class Partition<E> { // --------------- nested Locator class -------------
	...
	/**
	 * 20 * Finds the cluster containing the element identified by Position p 21 *
	 * and returns the Position of the cluster's leader. 22
	 */
