...
public class KruskalAlgortihm {

	public static void main(String[] args) {
		  /** Computes a minimum spanning tree of graph g using Kruskal's algorithm. */
		  public static <V> PositionalList<Edge<Integer>> MST(Graph<V,Integer> g) {  // tree is where we will store result as it is computed
		 ...
		 PriorityQueue<Integer, Edge<Integer>> pq = new HeapPriorityQueue<>( );
		  ...
		  while (tree.size( ) != size - 1 && !pq.isEmpty( )) {  Entry<Integer, Edge<Integer>> entry = pq.removeMin( );
