public class AdjacencyMapGraph<V, E> implements Graph<V, E> { // nested InnerVertex and InnerEdge classes defined
																// here...
	...
	public Edge<E> getEdge(Vertex<V> u,
			Vertex<V> v) { /** Returns the edge from u to v, or null if they are not adjacent. */
		InnerVertex<V> origin = validate(u);
		return origin.getOutgoing().get(v); // will be null if no edge from u to v
	}

	/** Returns the vertices of edge e as an array of length two. */
 public Vertex<V>[ ] endVertices(Edge<E> e) {3 InnerEdge<E> edge = validate(e);
