/**
 * 2 * Interface for a double-ended queue: a collection of elements that can be
 * inserted 3 * and removed at both ends; this interface is a simplified version
 * of java.util.Deque. 4
 */
