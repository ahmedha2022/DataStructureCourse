...
public class HeapPriorityQueue<K, V> extends AbstractPriorityQueue<K, V> {
	...
	protected ArrayList<Entry<K, V>> heap = new ArrayList<>();5
	...
	/** Inserts a key-value pair and returns the entry created. */
	 public Entry<K,V> insert(K key, V value) throws IllegalArgumentException {  checkKey(key); // auxiliary key-checking method (could throw exception)
	...
	/** Removes and returns an entry with minimal key (if any). */
	 public Entry<K,V> removeMin( ) {  if (heap.isEmpty( )) return null;
...
//	 public HeapPriorityQueue(K[ ] keys, V[ ] values) { super( );
